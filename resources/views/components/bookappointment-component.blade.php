<div class="bg-gray  pb-4">
    ...
    <div class="flex flex-row ">
        ...
        <div class="items-center ml-4 md:ml-10 xl:ml-12 2xl:ml-12 4/5">
            <p class="font-franklin font-medium items-center text-left text-xs pt-6 md:text-sm lg:text-base "><a href="{{route('webpages.guest.show', ['locale' => app()->currentLocale(), 'slug' => 'contact-us'])}}" @click.prevent.stop="$dispatch('linkaction', {link: '{{route('webpages.guest.show', ['locale' => app()->currentLocale(), 'slug' => 'contact-us'])}}', route: 'contact'})">{{ __('footer.send_us_message') }}<a></p>
