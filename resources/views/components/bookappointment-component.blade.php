<div class="bg-gray  pb-4">
    <div class="flex flex-row ">
        ...
        <div class="items-center 3/4">
            <p class="font-franklin font-medium items-center text-xl md:text-2xl lg:text-3xl pt-6 ml-3">{{ __('button.book_an_appointment') }}</p>
    ...
    <div class="flex flex-row ">
        ...
        <div class="items-center ml-4 md:ml-10 xl:ml-12 2xl:ml-12 4/5">
            <p class="font-franklin font-medium items-center text-left text-xs pt-6 md:text-sm lg:text-base ">{{ __('footer.send_us_message') }}</p>
